...
| 52 | 10 | **47.94** | 99.8 | 1 | 1 | ECW 5.634; second LIVE public Yahoo room from the REAL slot 10 (random humans, not the cast — excluded from the superlatives below, owner directive 2026-08-25), on the published v23 deck. Favored in 11/11 head-to-heads, season-shape 11/11, board rank 1 (+20.84; next +3.78). No punt at the start; the old advisor's FULL TILT (FG%+AST) was taken after #39 and retargeted at once to FG%+TO — the room-relative read (PR #37) calls that box inverted at all 9 turns it stood (TO beat 52–90% of the room while punted). Card 🎯 taken at 4/13 turns, a Top-5 row at 11/13; hindsight-best at #63/#87/#111. Costliest departures: Tatum #10 (card #15; Jalen Johnson +0.154 ECW) and Kyrie #39 (card #5; D. White +0.139). Follow-card arm 56.92%; best single swap swap#10:Jalen Johnson 52.82%. Two opponent picks poolless (Daniss Jenkins, Gui Santos: seats 4 and 11 play 12 men). Survival chips (still live on v23): BUY NOW on 47/50 scored rows at mean 0.028, 33 survived — pooled Brier 0.651 over 98 rows with mock 51 (`live_retro.py 52`, `live_deckcard.py`, `live_advisor.py`, `live_survival.py`, `debrief_2026-09-22_mock52_slot10.md`) |
| 53 | 10 | **38.53** | 99.3 | 1 | 1 | ECW 5.563; third LIVE public Yahoo room from the REAL slot 10 (random humans, not the cast — excluded from the superlatives below, owner directive 2026-08-25), on the same-day v24/v25 deck (Yahoo 9/22 prices baked, advice-only punt advisor, survival chips back on the price-only refit). Favored in 11/11 head-to-heads, season-shape 10/11, board rank 1 (+12.78; next +8.37). No punt declared and the advisor never advised (a room-relative AST lean at #58 and #82 only). Card 🎯 taken at 7/13 turns (#15, #34, #39, #63, #87, #106, #135), a Top-5 row at 8/13; hindsight-best at #15/#34/#63/#87/#106. Costliest departures: Tre Jones #130 (card #33; Christian Braun +0.141 ECW), Tatum #10 (card #17; Chet Holmgren +0.129), Reed Sheppard #111 (card #16; Braun +0.109). Follow-card arm 55.59%; best single swap swap#10:Chet Holmgren 46.26%. First out-of-sample room for the survival refit: 53 rows, Brier 0.217 vs this room's constant base rate 0.185 — the model under-predicts survival here (mean 0.501 vs realized 0.755); BUY NOW 4 of 8 gone, quiet 29 of 33 survived; pooled with 51+52, 152 rows, 0.197 vs 0.203. Insert-at-# used twice (Coby White #86, Portis #142), both verified correct against Yahoo's recap; the "you're on the clock" countdown defect reproduced in headless Chromium after the owner's 13th pick and fixed (engine clockRead, `m53_insert_integrity.md`, `debrief_2026-09-22_mock53_slot10.md`) |
