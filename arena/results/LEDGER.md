...
| 44 | 7 | 23.64 | 88.7 | 2 | 12 | v2, standard room; three-team race (Cayas 25.08, owner 23.64, Noah 21.66, cliff to 7.77; Kyle LAST from slot 12 — his two-win run was seat texture). EIGHTH optimal declaration in nine punted drafts: FT%/3PTM/PTS #1 of 84 at **+32.97, new record** (FG% +13.02 rank 1 — strongest single cat ever; REB/BLK also rank 1). BUT AST died undeclared (11, -4.06) — the m34/m35 dead-kept-cat returns: a 5-of-9 build with zero slack, priced 2nd only because all five live cats are rank 1-2. Doctrine refinement: a punt frame needs one genuine playmaker or AST must be declared. Card exact-#1 6/13, Top-5 11/13 (best since m36); only two off-card picks, both punt-fit (`season_sim_mock44.py`, `m44_replay.json`) |
| 45 | 8 | 12.05 | 74.1 | 4 | 12 | v2, standard room; Kyle wins again (25.77, Seat 4) — 3 of 4 recent rooms, but he was LAST in m44, so seat texture still dominates. Declared FT%/3PTM/TO is #2 of 84 (+26.83, within 0.29 of the #1 FT%/3PTM/PTS) — first NON-optimal declaration since m36, and PTS died anyway (rank 7, -0.64) making it a de-facto 4-cat concession. ST +10.51 is the strongest single category z ever measured (prior m44 FG% +13.02 is higher in absolute but ST at rank 1 by this margin is new); FG% +9.32 and REB rank 1 too. FT% -16.18 = deepest sink in the ledger. Card exact-#1 4/13; owner took Dylan Harper R11 off-card (see `findings_2026-08-06_dylan_harper_projection.md` — his row is a stale pre-rookie projection) (`season_sim_mock45.py`, `m45_replay.json`) |
| 46 | 9 | 2.59 | 30.9 | 9 | 12 | v2, standard room; WORST v2 owner result and the FIRST NEGATIVE SEAT-EDGE in 14 rooms (Seat 9 baseline 4.26 vs owner 2.59, -1.67pp; prior 13-of-13 positive, mean +13.34). Second frameless draft, and the frameless split now separates completely: declared (m40/43/44/45) mean 19.91% / finish 2.2 vs frameless (m42/46) mean 4.51% / finish 7.5, no overlap. Mechanism identical to m42: scoring stars early (Tatum/Lillard/Herro/Embiid/Sengun all off-card, 1/8 Top-5 through R8), card's defensive shell late (exact #1 on ALL of R9-R13), halves cancel - no cat above rank 2, PTS 11, 3PTM 12. Best implied frame only +6.43, weakest in the v2 ledger, and AST dead even under it (`season_sim_mock46.py`, `m46_replay.json`) |
| 47 | 10 | 12.49 | 68.8 | 3 | 12 | v2, standard room; declaration restored after the m46 frameless 9th -> back to 3rd, and Seat 10 is the WORST seat in the ledger (bot baseline 2.03) so the seat-edge is +10.46pp. Declared FT%/3PTM/TO is #1 of 84 (+24.49, next frame +16.74) and genuinely played (FT% -14.71, 3PTM -8.85, TO -6.34 all rank 12). NO dead kept cat - all six positive, three at rank 1-2 (FG% +5.88 rank 1, REB +6.39 rank 1, PTS +3.92 rank 2). Kept-total rank 10 vs champ rank 3 - yardstick split again. MOST owner-driven build measured: card exact-#1 only 2/13, Top-5 5/13, nine off-card picks all punt-fit stars/bigs (Kyrie, Giannis, Sengun, George, Zion, Banchero). Will wins the room 26.52 from Seat 1 (`season_sim_mock47.py`, `m47_replay.json`) |
| 48 | 4 | **46.03** | **98.0** | 1 | 12 | **BEST DRAFT IN THE LEDGER - all three headline records, in a STANDARD room**: champ 46.03 (prior 43.84 m41-sharp, 33.98 m39), playoff 97.96, ECW 5.137 - each computed from artifacts. 3.4x the next seat (Noah 13.58), widest margin measured; seat-edge +32.09pp over Seat 4's baseline 13.94, largest measured (15th positive in 16). NINTH optimal declaration in eleven punted drafts: FT%/3PTM/TO #1 of 84 (+26.42) and hard-played (FT% -12.7, 3PTM -11.2 both rank 12). FIRST build to satisfy all four doctrine conditions at once - no dead kept cat, THREE rank-1 cats (FG% +8.98, REB +6.23, BLK +4.17) plus ST rank 2, and AST alive at rank 4 because SGA/Trae/Amen protect it behind seven bigs (the m44 refinement, confirmed). Card exact-#1 5/13 supplying the spine; all six deviations punt-fit stars (`season_sim_mock48.py`, `m48_replay.json`) |
| 49 | 8 | 24.94 | 87.8 | 1 | 12 | v2, standard room; FIRST mock on the 245-row pool (post 8/9-8/10 refresh + main merge - seat baselines are 246-pool epoch, quote edges with that caveat). Room win at 24.94 in a TIGHT room (+2.75 over Kyle's Seat-2 balanced build at 22.19); seat-edge +21.74pp over Seat 8's baseline 3.20 (16th positive in 17). TENTH optimal declaration in twelve punted drafts: FT%/3PTM #1 of 36 two-cat frames (+21.42, runner-up +11.76) and hard-played (FT% -11.72, 3PTM -11.11 both rank 12); the natural third cat (PTS, best 3-frame +22.87) was left in and drifted to rank 10 (-1.45) - kept-cat drift, not dead. THREE rank-1 cats (FG% +9.10, REB +5.84, BLK +3.41) + ST rank 3; AST alive rank 5 behind Brunson/Trae/Jrue/Caruso (m44 refinement again). m48 shape replicated: first five rounds ALL off-card punt-fit stars (AD, Giannis, Brunson, Trae, Sengun vs card's KAT/Murray/Daniels/OG/Eason), then R6-R13 exact-#1 7/13 with only Gobert (R9, Top-5) deviating - card supplied the entire back-half spine. SIX C-eligibles but daily-fill start rates NEVER bind: lowest w on the roster is Jrue 0.960, Gobert 0.980 (AD/Giannis flex PF) - the measured answer to the owner's lineup-cap concern on this build. Mid-draft owner question answered live: Zion (Fit +1.41 mirage) passed at #80 for the card's Allen; Zion went to Noah at #91, Seat 6 finished 10th at 2.57 (anecdote, not causal) (`season_sim_mock49.py`, `m49_replay.json`) |
| 50 | 2 | 26.64 | 94.0 | 1 | 12 | v2, standard room, 245-pool epoch; SECOND consecutive room win and the FIRST clean sweep - rank 1 on every yardstick (champ, playoff 93.95, ECW 5.01, 9cat-z +8.43, kept +20.96) - in a photo-finish room (+0.78 over Kyle's Seat-1 25.86). TWO FIRSTS: (a) first AST-punt in the ledger - AST/3PTM/PTS, a defense/efficiency frame KEEPING FT%, is #1 of 84 (+20.96, runner-up +17.57; eleventh optimal declaration in thirteen punted drafts), hard-played (AST -5.09, PTS -4.14 rank 12; 3PTM rank 10), all six kept cats positive with TO +9.41 rank 1 - the largest single-cat edge in any graded mock; (b) HIGHEST card agreement ever - exact-#1 12/13, Top-5 13/13 (lone deviation Claxton over T Harris R12) - live card autopilot replicating the integrity audit's synthetic card-following arm (23.76) at 26.64 from Seat 2. Doctrine observation (n=1, not an edit): the protect-AST step inverted - the card's organic Seat-2 flow conceded AST entirely and the owner's declaration was DESCRIPTIVE (named the frame the card was building); step 1 of the doctrine subsumes step 2 when the concession is coherent. Census G4/F6/C5, daily-fill never binds (low w Claxton 0.979). Seat-edge +12.56 over 14.08 baseline (246-pool caveat), 17th positive in 18 (`season_sim_mock50.py`, `m50_replay.json`) |
| 51 | 5 | 21.45 | 83.8 | 1 | 12 | v2, standard room, 245-pool epoch; THIRD consecutive room win but a STATISTICAL TIE at the top (+0.24 over John's Seat-4 21.21 on 18k seasons - read as co-favorite, not a clear win; Cayas 18.45 third). TWELFTH optimal declaration in fourteen punted drafts - FT%/3PTM/AST #1 of 84 - but the SOFTEST winning frame yet (+12.17 vs m49 +21.42/m50 +20.96) and only half-played: FT% -10.73 rank 12 hard, 3PTM -1.45 rank 8 and AST -1.43 rank 10 semi-live (Ant Edwards headlining an FT%/3PTM punt is the shape mismatch). Kept PTS drifted negative AGAIN (-1.30 rank 9, second straight) - ceiling capped vs the 46%-class builds. Card exact-#1 6/13, Top-5 9/13; Giannis over D White R3 the punt-fit-star move, card supplied the guard spine (Amen/Sheppard/Wallace/Herb/Ellis exact). Census G6/F6/C5, daily-fill never binds (DLo 0.968). Seat-edge +17.12 over 4.33 baseline (246-pool caveat), 18th positive in 19. DAY SUMMARY: mocks 49-51 same day, three seats (8/2/5), three frame families, three rank-1s - the declaration discipline is the common factor (`season_sim_mock51.py`, `m51_replay.json`) |
| 52 | 12 | 15.66 | 73.3 | 2 | 12 | v2, standard room, 245-pool epoch; THIRD frameless draft and the FIRST that did not collapse - 2nd of 12 from the wheel (Cayas wins 21.25), seat-edge +12.30 over Seat 12's 3.36 baseline (246-pool caveat), 19th positive in 20. REVISES the m46 'no overlap' claim (append-only: m46 row stands, this row records the update): 15.66 beats declared m45 12.05 and m47 12.49. Updated split - declared (9 mocks) mean 22.24/finish 1.8 vs frameless (m42/46/52) mean 8.23/finish 5.7: frameless still clearly worse on average, but the mechanism refines. Same flat signature as m42/m46 (no cat above rank 3, best implied frame only +5.30 - weaker than m46's +6.43, kept-z rank 9) yet ECW rank 2 - the yardstick split at its widest. The difference: card agreement 9/13 exact / 10/13 Top-5 INCLUDING R1/R2 (m46 was 1/8 Top-5 through R8) - no dueling halves. REFINED HYPOTHESIS (n=3, not law): COHERENCE is the load-bearing variable, reachable two ways - declared frame + judgment inside it (every 20%+ result), or card autopilot (m50, m52); the failure mode is heavy early judgment with no frame reconciling it (m42/m46). Census G6/F4/C4, daily-fill fine (K George 0.964) (`season_sim_mock52.py`, `m52_replay.json`) |
| 53 | 5 | **28.71** | 90.7 | 1 | 12 | v2, standard room, 245-pool epoch; SECOND-BEST standard-room result in the ledger (behind m48 46.03) and it is FRAMELESS CARD AUTOPILOT: exact-#1 12/13 (ties m50's record) with ONE deviation - Giannis over Mobley R2, fully off-card, the punt-fit-star move for the flow's implied frame. Blowout room: 2.5x Martin's 11.63. The card organically rebuilt the m50 shape undeclared - FG% +7.71 and TO +8.02 both rank 1, ST/BLK rank 3, glamour cats conceded (PTS/AST/3PTM/FT% rank 10-11), best implied frame 3PTM/PTS/AST +16.63 (vs m52's flat +5.30). Frameless now splits PERFECTLY by steering: judgment-heavy m42/m46 = 6.43/2.59 (6th/9th) vs autopilot m52/m53 = 15.66/28.71 (2nd/1st) - coherence, not declaration, registered as E26 (SEPTEMBER-PLAN §9, pre-registered counterfactual design + bar; five same-day rooms is suggestive, not controlled). Seat-edge +24.38 over 4.33 baseline - SECOND-LARGEST measured (m48 +32.09 leads), 20th positive in 21 (246-pool caveat). DAY QUINTET: m49-53 all top-2 (1,1,1-tie,2,1) across three coherence modes. Census G6/F4/C4, REB -1.42 rank 7 the one leak (`season_sim_mock53.py`, `m53_replay.json`) |

**Ledger-wide superlatives (recomputed from artifacts 2026-08-06):** best
champ% = **m48 (46.03)**, best playoff% = **m48 (97.96)**, best ECW =
**m48 (5.137)** — all three in a standard room; runner-up on each is m41
(43.84 / 96.65 / 5.111), which is SHARP-room and asterisked. m28's 34.58
is a hindsight oracle, not a draft. Cross-epoch caveat stands: v1 and v2
champ% are not directly comparable, so these are "highest recorded",
with the epoch noted per row.

Verified superlatives (v1 epoch, mocks 10–39 — m40+ are v2 and NOT
