...
STATE = "/root/.claude/uploads/58588377-022f-59e5-ac2c-106514acd881/c0d8a926-draft_state_14.json"
OWNER = 2
...
ARMS = {
  "as_drafted": {},
  "CF1_wemby_to_sga": {                    # REPLICATION of the m24 empty-roster test
      "Victor Wembanyama": "Shai Gilgeous-Alexander",
  },
  "CF2_kd_to_murray": {                    # deepest deviation, board 13 (delta -2.72)
      "Kevin Durant": "Jamal Murray",
  },
  "CF3_tatum_to_murray": {                 # the same 🎯 passed twice, board 5 (delta -1.18)
      "Jayson Tatum": "Jamal Murray",
  },
}
...
json.dump(out, open("/tmp/claude-0/-home-user-yahoo-fantasy-basketball/58588377-022f-59e5-ac2c-106514acd881/scratchpad/mock25_cf_out.json", "w"), indent=1)
print("wrote mock25_cf_out.json")
