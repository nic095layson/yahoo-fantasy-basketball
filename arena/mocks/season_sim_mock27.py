...
json.dump(out, open("/tmp/claude-0/-home-user-yahoo-fantasy-basketball/58588377-022f-59e5-ac2c-106514acd881/scratchpad/season_sim_mock27_out.json", "w"), indent=1)
print("\nwrote season_sim_mock27_out.json")
